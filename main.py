...
async def run_analysis(request: AnalysisRequest):
    try:
        ...
        if request.enable_profiling:
            ...
            green_agent = green_plugin.get_agent(llm, agents_config['green_ai_officer'])
            task_green = green_plugin.get_task(task_config['green_ai_analysis_task'],green_agent, request.instruction)
