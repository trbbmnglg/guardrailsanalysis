# ======================================================================
# agent_tools.py (Final Path & ClassVar Fix)
# ======================================================================
...
# This variable is automatically accessible to functions/methods below
...
class OwaspSecurityRAGTool(BaseTool):
    ...
    def __init__(self):
        super().__init__()
        # FIX: The global keyword is removed, and PDF_PATH is used directly.
        # It is visible because it was defined in the module scope above.
        try:
            # Initialize the PDFSearchTool instance
